...
const Sidebar = ({
  ...
  return (
    <div
      className={`h-full sm:max-w-sm rounded-xl bg-gray-900 border border-gray-800
            ...
            .map((message) => {
              ...
              if (isMessage) {
                ...
                return (
                  <div
                    key={ver.id}
                    className='w-4/5 mx-auto my-2 p-3 rounded-xl bg-gray-800
                 text-gray-100 shadow flex flex-col gap-2'
                  >
                    <div>
                      code updated <br />
                      <span>
                    ...
                    <div className='flex items-center justify-between'>
                      ...
                      >
                        <EyeIcon
                          className='size-6 p-1 bg-gray-700 hover:bg-indigo-500
          ...
          <div className='flex items-center gap-2'>
            <textarea
              ...
              className='flex-1 p-3 rounded-xl resize-none text-sm outline-none
                 ring ring-gray-700 focus:ring-indigo-500
